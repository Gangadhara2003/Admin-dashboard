...
export default function AdminOrdersPage() {
    ...
    return (
        <div>
            ...
            {showSendModal && (
                <div className="fixed inset-0 bg-black flex items-center justify-center z-[1000]" onClick={() => !sendLoading && setShowSendModal(false)}>
                                            ...
                                            <>
                                                ...
                                                <div className="space-y-3 mb-4">
                                                    {suggestions.map((s: any) => {
                                                        ...
                                                        return (
                                                            <div key={s.supplierId} className={`border p-4 transition-all ${selected.length > 0 ? 'border-blue-300 bg-accent/10/30' : 'border-white/10'
                                                                }`}>
                                                                <div className="flex items-center justify-between mb-3">
                                                                    ...
                                                                    <span className={`px-2 py-0.5 text-[10px] font-bold rounded-full ${selected.length === s.matchedProducts.length ? 'bg-green-500/100/20 text-green-400' : selected.length > 0 ? 'bg-accent/20 text-blue-700' : 'bg-white/10 text-white/50'
                                                                        }`}>
