...
export default function AdminProductsPage() {
    ...
    return (
        <div>
            ...
            {isShopifyModalOpen && (
                <div className="fixed inset-0 bg-black flex items-center justify-center z-[1000]" onClick={() => !shopifySaving && setIsShopifyModalOpen(false)}>
            ...
            {viewProduct && source === 'shopify' && (
                <div className="fixed inset-0 bg-black flex items-center justify-center z-[1000]" onClick={() => setViewProduct(null)}>
            ...
            {/* ===== MongoDB Edit Modal ===== */}
            {isEditOpen && (
                <div className="fixed inset-0 bg-black flex items-center justify-center z-[1000]" onClick={() => !saving && setIsEditOpen(false)}>
                    <div className="w-full max-w-lg max-h-[90vh] overflow-y-auto bg-white/5 border-2 border-white/10 p-6" onClick={e => e.stopPropagation()}>
    ...
    return (
        <div className="bg-white/5 border-2 border-white/10 overflow-hidden hover: hover:border-white/20 transition-all group flex flex-col h-full" onClick={onView}>
            <div className="relative aspect-[4/3] bg-white/5 overflow-hidden cursor-pointer">
                ...
                {p.images?.length > 1 && <span className="absolute top-2 right-2 px-2 py-1 bg-black text-white text-[10px] font-bold ">{p.images.length} imgs</span>}
